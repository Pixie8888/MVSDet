...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True,
        pad_size_divisor=10), # size can be devided by 10.
    backbone=dict(
        type='mmdet.ResNet',
        depth=50,
        num_stages=4,
...
data_root = '/home/yating/Documents/nerf/imvoxelnet/data/scannet/'
class_names = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='/home/yating/Documents/nerf/imvoxelnet/data/scannet/scannet_infos_train_new.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/home/yating/Documents/nerf/imvoxelnet/data/scannet/scannet_infos_val_new.pkl',
