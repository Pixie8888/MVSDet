...
def process_scene(path, limit, idx):
    ...
    data.export_depth_images(output_path) # depth image
...
if __name__ == '__main__':
    ...
    if os.path.exists('/mnt/6202BA0A02B9E369/ScanNet/scans'):
        process_directory('/mnt/6202BA0A02B9E369/ScanNet/scans', args.max_images_per_scene, args.nproc)
    # process test scenes
